          ...
          column(
            ...
            box(
              ...
              div(
                ...
                # Área de cards
                                uiOutput("cards_importados_validacao_ml"),
  ...
  observeEvent(input$carregar_validacao_ml, {
    ...
    output$cards_validacao_ml <- renderUI({
      ...
      cards <- lapply(1:nrow(dados_validacao), function(i)  {
        ...
        tipo_sugerido <- if (!is.null(registro$tipo_sugerido) && !is.na(registro$tipo_sugerido) && registro$tipo_sugerido != "") registro$tipo_sugerido else if (!is.null(registro$tipo_novo) && !is.na(registro$tipo_novo) && registro$tipo_novo != "") registro$tipo_novo else "-"
